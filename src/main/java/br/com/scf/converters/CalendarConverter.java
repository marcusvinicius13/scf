...
public class CalendarConverter implements Converter<Calendar>{
	...
	@Override
	public Calendar getAsObject(FacesContext context, UIComponent component, String dataTexto) {
	...
	@Override
	public String getAsString(FacesContext context, UIComponent component, Calendar dataObject) {
		if(dataObject == null)
			return null;
